...
export const playerDiscoverySurvey: SurveyConfig = {
  ...
  sections: [
    ...
    // ── Section 6: Research Behavior & Demographics ──
    {
      ...
      questions: [
        ...
        },
        {
          ...
          hasOtherOption: true,
          options: [
            { key: 'us', labelKey: 'survey.player.q18.options.us' },
            { key: 'canada', labelKey: 'survey.player.q18.options.canada' },
            { key: 'mexico', labelKey: 'survey.player.q18.options.mexico' },
            { key: 'brazil', labelKey: 'survey.player.q18.options.brazil' },
            { key: 'argentina', labelKey: 'survey.player.q18.options.argentina' },
            { key: 'colombia', labelKey: 'survey.player.q18.options.colombia' },
            { key: 'chile', labelKey: 'survey.player.q18.options.chile' },
            { key: 'uk', labelKey: 'survey.player.q18.options.uk' },
            { key: 'germany', labelKey: 'survey.player.q18.options.germany' },
            { key: 'france', labelKey: 'survey.player.q18.options.france' },
            { key: 'spain', labelKey: 'survey.player.q18.options.spain' },
            { key: 'portugal', labelKey: 'survey.player.q18.options.portugal' },
            { key: 'netherlands', labelKey: 'survey.player.q18.options.netherlands' },
            { key: 'poland', labelKey: 'survey.player.q18.options.poland' },
            { key: 'sweden', labelKey: 'survey.player.q18.options.sweden' },
            { key: 'italy', labelKey: 'survey.player.q18.options.italy' },
            { key: 'australia', labelKey: 'survey.player.q18.options.australia' },
            { key: 'japan', labelKey: 'survey.player.q18.options.japan' },
            { key: 'south_korea', labelKey: 'survey.player.q18.options.south_korea' },
            { key: 'philippines', labelKey: 'survey.player.q18.options.philippines' },
            { key: 'india', labelKey: 'survey.player.q18.options.india' },
            { key: 'russia', labelKey: 'survey.player.q18.options.russia' },
            { key: 'turkey', labelKey: 'survey.player.q18.options.turkey' },
            { key: 'other', labelKey: 'survey.player.q18.options.other' },
          ],
        },
      ],
    },
    ...
    {
      key: 'survey_feedback',
      titleKey: 'survey.player.sections.survey_feedback.title',
      questions: [
        {
          key: 'q_feedback_rating',
          type: 'csat_scale',
          titleKey: 'survey.player.q_feedback_rating.title',
          subtitleKey: 'survey.player.q_feedback_rating.subtitle',
        },
        {
          key: 'q_feedback_text',
          type: 'open_text',
          titleKey: 'survey.player.q_feedback_text.title',
          subtitleKey: 'survey.player.q_feedback_text.subtitle',
          optional: true,
        },
      ],
    },
